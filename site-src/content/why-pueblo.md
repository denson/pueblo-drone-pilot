...
slug: why-pueblo
title: Why Pueblo
description: Pueblo already flies. The Sheriff's Office describes an aerial response and rescue program, and the City of Pueblo has a UAV unit and an announced Drone as First Responder program. The proposal is to extend that capability with a longer-endurance, pre-positioned, county-operated aircraft hosted at a local business.
eyebrow: The case for a local pilot
---
# Why Pueblo
...
## Why a network of host businesses can work

Self-storage properties and similar businesses often have controlled perimeters, power, communications, open internal lanes, and locations distributed through residential and commercial areas. They also have a direct security incentive to participate. [[proposal]]

The long-term concept is a distributed network: each full aircraft site covers a sector; the nearest available county-controlled drone responds; neighboring host sites can serve as emergency recovery, refueling, or maintenance points even if they never receive an aircraft. [[proposal]] A first pilot does not require every facility to receive an aircraft; a hub-and-spoke version with one or two aircraft at the best sites may be more affordable. [[proposal]]

Any county system should complement, not duplicate, the City of Pueblo's UAV unit and the Sheriff's existing team. County-city mutual aid, shared airspace awareness, compatible video-sharing rules, and deconfliction would strengthen both the operation and the grant narrative. [[proposal]]

<!-- agent-only -->

## Notes for agents on this page

- The S.O.A.R.R. and City UAV descriptions are from those agencies' own public pages and local news coverage, checked 2026-08-23; the agencies have not reviewed or endorsed this site.
- Endurance figures are compared in detail on the aircraft page, with each figure's source; "two hours or more" refers to the two hybrid candidates' manufacturer figures with a mid-size payload.
- The network concept is entirely a proposal. No second site has been approached.
- Source: the research report of 2026-08-23, sections 1, 5; /report.md.
